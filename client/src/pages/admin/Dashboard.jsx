...
/**
 * AdminDashboard.jsx
 * Enterprise SaaS LMS Admin Dashboard — clean version without Sidebar
 * Sidebar is now handled by AdminLayout.jsx
 */
...
function StatCard({ label, value, icon, prefix = '', suffix = '', delta, deltaLabel, accent, loading }) {
  const accents = {
    indigo:  { glow: 'rgba(99,102,241,0.2)',  border: 'rgba(99,102,241,0.25)',  icon: 'rgba(99,102,241,0.15)' },
    emerald: { glow: 'rgba(16,185,129,0.2)',  border: 'rgba(16,185,129,0.25)',  icon: 'rgba(16,185,129,0.15)' },
    amber:   { glow: 'rgba(245,158,11,0.2)',  border: 'rgba(245,158,11,0.25)',  icon: 'rgba(245,158,11,0.15)' },
    cyan:    { glow: 'rgba(6,182,212,0.2)',   border: 'rgba(6,182,212,0.25)',   icon: 'rgba(6,182,212,0.15)' },
    fuchsia: { glow: 'rgba(217,70,239,0.2)',  border: 'rgba(217,70,239,0.25)',  icon: 'rgba(217,70,239,0.15)' },
    purple:  { glow: 'rgba(139,92,246,0.2)',  border: 'rgba(139,92,246,0.25)',  icon: 'rgba(139,92,246,0.15)' },
    rose:    { glow: 'rgba(244,63,94,0.2)',   border: 'rgba(244,63,94,0.25)',   icon: 'rgba(244,63,94,0.15)' },
  };
  const c = accents[accent] || accents.indigo;
  const positive = typeof delta === 'string' ? !delta.startsWith('-') : delta >= 0;
